...
const adminHtmlPath = path.join(dist, "admin.html");
const outputPath = path.join(root, "exports", "standalone", "whistle-admin-console.html");
...
if (!fs.existsSync(adminHtmlPath)) {
  throw new Error("dist/admin.html not found. Run npm run build before exporting.");
}
...
window.__WHISTLE_ADMIN_ASSETS__ = {
...
html = html.replace(/<script type="module" src="\/src\/admin-main\.tsx"><\/script>/, "");
