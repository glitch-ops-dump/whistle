...
const dashboardHtmlPath = path.join(dist, "dashboard.html");
const outputPath = path.join(root, "exports", "standalone", "whistle-dashboard.html");
...
if (!fs.existsSync(dashboardHtmlPath)) {
  throw new Error("dist/dashboard.html not found. Run npm run build before exporting.");
}

let html = read(dashboardHtmlPath);
...
html = html.replace(/<script type="module" src="\/src\/gov-main\.tsx"><\/script>/, "");
