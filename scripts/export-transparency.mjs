...
const htmlPath = path.join(dist, "transparency.html");
const outputPath = path.join(root, "exports", "standalone", "whistle-public-transparency.html");
...
if (!fs.existsSync(htmlPath)) {
  throw new Error("dist/transparency.html not found. Run npm run build before exporting.");
}
...
window.__WHISTLE_PUBLIC_ASSETS__ = {
...
html = html.replace(/<script type="module" src="\/src\/transparency-main\.tsx"><\/script>/, "");
