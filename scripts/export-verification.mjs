...
const htmlPath = path.join(dist, "verification.html");
const outputPath = path.join(root, "exports", "standalone", "whistle-verification-console.html");
...
if (!fs.existsSync(htmlPath)) {
  throw new Error("dist/verification.html not found. Run npm run build before exporting.");
}
...
window.__WHISTLE_VERIFICATION_ASSETS__ = {
...
html = html.replace(/<script type="module" src="\/src\/verification-main\.tsx"><\/script>/, "");
